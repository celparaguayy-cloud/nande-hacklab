...
export const FLAG_INFO: Record<string, { tecnica: string; defensa: string }> = {
  ...
  "ND{ssh_fuerza_bruta}": { tecnica: "Fuerza bruta de credenciales (SSH)", defensa: "Claves fuertes, bloqueo por intentos, MFA y fail2ban." },
  ...
  "ND{c2_deteccion}": { tecnica: "Detección de C2 (beaconing)", defensa: "Detectar conexiones periódicas y regulares al mismo destino." },
};
